...
app.get("/", function(req, res){
  res.render("home", {homeStartingCEJS: homeStartingContent, arrEJS: arr});
});
...
app.get('/post/:para', function (req, res) {
  const requestTitle = _.lowerCase(req.params.para);
  arr.forEach(function(a){
  const storeTitle = _.lowerCase(a.post);
  const currTitle = a.post;
  const currContent = a.content;
